    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      >
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold font-satoshi text-foreground tracking-tight">
            GENBOX
          </h1>
          <h2 className="text-xl font-semibold text-foreground">Masuk ke GENBOX</h2>
        </div>
        ...
        <div className="flex items-center justify-between text-sm">
          <Link to="/forgot-password" className="text-muted-foreground hover:text-primary hover:underline text-xs">
            Lupa password?
          </Link>
